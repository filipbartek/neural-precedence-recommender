...
a native support for equational reasoning. The calculus is parameterized by a simplification ordering on terms % and literals,
...
and pairs of randomly sampled precedences. This information is then used to train
