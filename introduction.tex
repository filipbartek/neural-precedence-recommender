...
A \gls{fol} problem consists of \gls{fol} formulas of two categories:
premises and a conjecture.
...
infer new provable clauses by applying the rules of \definiendum{superposition calculus}.
...
that is a permutation of predicate and function symbols of the input problem.
...
The structure of the problem contains a lot of information that is relevant for the choice of symbol precedence,
