...
% https://tex.stackexchange.com/a/335997/202639
...
% We cannot use pacakge sectsty or titlesec to bulk-format all section titles
% because the style llncs re-defines \subsubsection to typeset as \paragraph.
...
\section{\titlecap{Training procedure}}
\label{sec:training}
\input{training}

\section{\titlecap{Experimental evaluation}}
\label{sec:evaluation}
\input{evaluation}

\section{\titlecap{Related work}}
\label{sec:related}
\input{related}

\section{\titlecap{Conclusion and future work}}
