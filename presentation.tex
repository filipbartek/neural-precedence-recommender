...
\begin{frame}
\frametitle{Graph representation of $a=b \wedge f(a,b) \neq f(b,b)$}
...
\todo{Sketch the proof by inserting $C(\pi) < C(\rho)$, where $\pi$ is a diagram of a sorted sequence, and $\rho$ is a diagram of an unsorted sequence.}
...
\todo{Plot the loss. See: https://tex.stackexchange.com/a/105643/202639, pgfplots}
