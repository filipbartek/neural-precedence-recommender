...
\todo[author=FB]{I propose we ignore this comment because I don't understand its point and I can't think of a straightforward way to improve the clarity of the relevant part of the paper.}
