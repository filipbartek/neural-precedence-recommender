...
The edges along which the loss gradient is backpropagated and the trainable modules are shown bold.}
...
pi [label=<Precedence &pi;> pos="10,10!"];
...
SymbolCostModel [style=<rounded,bold>, label="Output unit"];
