...
\todo[author=FB]{I propose we ignore this comment because I do not understand its point and I cannot think of a straightforward way to improve the clarity of the relevant part of the paper.}
...
It is easy to see that all precedences that sort the symbol costs in a non-increasing order
