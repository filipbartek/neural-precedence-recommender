...
such as predicate symbols, atoms, and clauses.
...
converts them by the edge modules of the adjacent edges to form the messages,\todo{MS: ``message'' occurs for the first time. 
...
In the simple case that each edge module is a dense layer,\todo{MS: hnidopich nevi, co to znamena ``dense layer''}
